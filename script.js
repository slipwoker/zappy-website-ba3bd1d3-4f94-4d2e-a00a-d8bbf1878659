document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyScrollAnimations() {
    const animatableEls = document.querySelectorAll(OBSERVE_SELECTOR);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ba3bd1d3-4f94-4d2e-a00a-d8bbf1878659',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ba3bd1d3-4f94-4d2e-a00a-d8bbf1878659';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ba3bd1d3-4f94-4d2e-a00a-d8bbf1878659';
